...
* Unify curried and multi-param function types — `(int => (int => int))` should be assignable from `(int -> int => int)` since partial application already makes them behave identically at call sites
